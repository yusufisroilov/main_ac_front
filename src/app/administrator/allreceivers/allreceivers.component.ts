...
export class AllreceiversComponent implements OnInit {
  ...
  constructor(private http: Http, private httpClient: HttpClient,private router: Router,public authService: AuthService) { 
    ...
    this.http.get(GlobalVars.baseUrl + '/regions/list', this.options)
    .subscribe(response => {
  ...
  getListOfRecs(){
    ...
    return  this.http.get(GlobalVars.baseUrl+'/receivers/listForStaff?page='+ this.currentPage+'&size=50', this.options)
      .subscribe(response => {
  ...
  editReceiver(id,parent_id, client_name	, first_name, last_name, pass_ser, pass_num, pinfl,phone_number, region_id, district_id,street, apartment) {
  ...
  getListOfRecsWithFilter(parentId,passportCont,ownid,status){
   ...
   let filterLink = '&parentID='+parentId+"&passport="+passportCont+"&id="+ownid + "&statusQuarter=" + status;
    return  this.http.get(GlobalVars.baseUrl+'/receivers/listForStaff?page='+ this.currentPage+'&size=50'+filterLink, this.options)
      .subscribe(response => {
        this.allRecs = response.json().receivers;
  ...
  putAdressInfo(recidsi, modParentID, modRegionw, modDistrict, modStreet, appartment)
  {
  ...
  this.http.get(GlobalVars.baseUrl + '/regions/town/'+ modRegionw, this.options)
            .subscribe(response => {
  ...
  changeStatus(CId, message) {
    ...
    swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.http.post(GlobalVars.baseUrl + '/receivers/changeStatus?receiver_id='+CId,'', this.options)
        .subscribe(response => {
  ...
  changeParentID(iddd)
  {
    ...
    swal.fire({
      ...
      preConfirm: (valueB) => {
            ...
            this.http.post(GlobalVars.baseUrl + '/receivers/changeParent?receiver_id=' + iddd + '&parent_id=' +valueB   ,"", this.options)
            .subscribe(response => {
  ...
  deleteRec(iddd)
  {
    ...
    swal.fire({
      ...
      preConfirm: () => {
            ...
            this.http.delete(GlobalVars.baseUrl + '/receivers/delete?rid=' + iddd  ,this.options)
            .subscribe(response => {
...
*/
  ...
  takeRegions()
    ...
    takeDistrictsEdit(regID)
    {
            ...
            return this.http.get(GlobalVars.baseUrl + '/regions/town/'+ val, options)
            .subscribe(response => {
              this.districts = response.json().towns;
