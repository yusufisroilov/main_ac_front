    ...
    swal
      .fire({
        ...
        preConfirm: (result) => {
          ...
          this.http
            .post(GlobalVars.baseUrl + "/register", dataUser, this.options)
            .subscribe(
              (response) => {
                if (response.json().status == "error") {
                  ...
                  swal
                    .fire({
                      ...
                      html:
                        "<div><b>Kent GA:</b> <br>Sizning yangi IDingiz: K" +
                        newId +
                        "<br>  Sistemaga kirish uchun: <br> Link: my.acargo.uz \n  <br>" +
                        "Login: " +
                        phone_num +
                        " <br>" +
                        "Parol: " +
