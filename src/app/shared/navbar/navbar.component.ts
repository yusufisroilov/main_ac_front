...
export class NavbarComponent implements OnInit, OnDestroy {
  ...
  ticketNotifications: NotificationItem[] = [];
  deliveryNotifications: NotificationItem[] = [];
  ...
  // ============================================
  // SIDEBAR FUNCTIONS (Keep existing)
  // ============================================
  minimizeSidebar() {
  ...
  ngOnDestroy() {
    ...
    if (this.ticketNotificationSubscription) {
      this.ticketNotificationSubscription.unsubscribe();
    }
    if (this.deliveryNotificationSubscription) {
      this.deliveryNotificationSubscription.unsubscribe();
    }
  ...
  onDocumentClick(event: MouseEvent) {
    ...
    const clickedInside = target.closest(".notification-dropdown-container");
    if (!clickedInside) {
      this.closeTicketDropdown();
      this.closeDeliveryDropdown();
    }
  ...
  // ============================================
  // EXISTING SIDEBAR METHODS (Keep as is)
  // ============================================
  onResize(event) {
    if ($(window).width() > 991) {
      return false;
