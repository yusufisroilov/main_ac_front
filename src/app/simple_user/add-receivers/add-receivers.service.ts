...
@Injectable()
export class AddReceiversService {
  ...
  //  private options = { headers: new HttpHeaders().set('Content-Type', 'application/json') };
    ...
    let options = new RequestOptions({ headers: headers });
            ...
            return this.http.post(GlobalVars.baseUrl + '/receivers/add', 
            ...
            .map(response =>{
                ...
                if(result.status == 'error')
                {
                    this.checkPassportMessageS = result.message;
                        ...
                        swal.fire({
                            title: 'ATMEN Bo\'ldi Xullas',
                            text: 'Bu pasport bor ekan Bob! Oxiri so\'ragan narsangni qildim :)',
                            icon: 'error',
                            customClass: {
